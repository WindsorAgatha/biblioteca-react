      ...
      >
        <div className="flex items-center min-w-[150px] mr-0 gap-3">
          <img
            ...
            alt="Logo da escola"
          />
          <div onClick={()=>  setIsDarkMode(!isDarkMode)} className='bg-slate-400 w-20 rounded-md flex h-6 justify-between items-center relative p-1 cursor-pointer'>
            <FontAwesomeIcon icon={faMoon} className="text-sky-500" />
            <button className={`bg-slate-700 h-5 rounded-full w-5 absolute transition 300s ${isDarkMode ? 'translate-x-0 ' : 'translate-x-6'}`}></button>
